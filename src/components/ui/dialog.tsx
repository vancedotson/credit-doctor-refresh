...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="group absolute right-1 top-1 z-[102] flex size-8 sm:size-7 items-center justify-center rounded-lg outline-offset-2 transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-ring/70 disabled:pointer-events-none bg-white/95 hover:bg-white pointer-events-auto shadow-lg">
        <Cross2Icon
          width={16}
          height={16}
          strokeWidth={2}
          className="opacity-90 transition-opacity group-hover:opacity-100 text-black"
        />
